...
const NotFound = () => {
  return (
    <div className="flex flex-col justify-center items-center h-screen w-full bg-primary text-primary">
      ...
      <h1 className="text-8xl md:text-9xl font-extrabold tracking-widest">404</h1>
      ...
      <button className="mt-8 group">
        ...
        >
          ...
          <span className="relative block px-8 py-3 bg-secondary text-primary border border-secondary transition-colors 
