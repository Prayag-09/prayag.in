								...
								<Link to={item.path} key={idx}>
									<li className='flex'>
										...
										<div className='ml-4 mb-4'>
											...
											<p className='text-secondary-text'>{item.info}</p>
										</div>
									</li>
								</Link>
							))}
					...
					<form className='space-y-8' noValidate>
						...
						<div>
							...
							<input
								...
								id='email'
								name='email'
								className='shadow-sm bg-third border border-third text-primary-text text-base rounded-lg focus:ring-primary-500 block w-full p-2.5 placeholder-secondary-text focus:outline-none focus:right-2 focus:border-secondary'
						...
						<CustomButton label={'Send message'} onClick={handleSendMessage} />
					</form>
				</motion.div>
			</div>
		</section>
...
const contactData = [
	...
	},
	{
		...
		icon: <FaHashnode size={24} />,
		info: '@t-prayag',
		path: 'https://t-prayag.hashnode.dev/',
	},
];
