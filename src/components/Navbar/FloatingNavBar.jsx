...
const fixedNav = [
	{
		name: 'Home',
		icon: <IconHome className='h-4 w-4 fill-white hover:fill-secondary' />,
	},
	{
		name: 'About',
		icon: <IconUser className='h-4 w-4 fill-white hover:fill-secondary' />,
	},
	{
		name: 'Projects',
		icon: <IconPrompt className='h-4 w-4 fill-white hover:fill-secondary' />,
	},
	{
		name: 'Blog',
		icon: <IconArticle className='h-4 w-4 fill-white hover:fill-secondary' />,
	},
];

const FloatingNavBar = ({ className = '', visible }) => {
